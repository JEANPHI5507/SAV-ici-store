  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        purple: "border-transparent bg-purple-100 text-purple-800 hover:bg-purple-200/80",
        orange: "border-transparent bg-orange-100 text-orange-800 hover:bg-orange-200/80",
        ...
        indigo: "border-transparent bg-indigo-100 text-indigo-800 hover:bg-indigo-200/80",
      },
    },
    defaultVariants: {
      variant: "default",
